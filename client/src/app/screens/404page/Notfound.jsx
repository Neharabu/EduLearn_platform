...
import fourofour from '../../../assets/404-computer.svg'
import {Link} from 'react-router-dom'


const Notfound = () => {
  return (
    <section className='w-full flex-col h-screen flex  gap-5 justify-center items-center'>
<img src={fourofour} className='w-1/3 phone:w-2/3' alt="" />
